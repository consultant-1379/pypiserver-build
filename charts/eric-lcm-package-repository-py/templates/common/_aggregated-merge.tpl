...
*/ -}}
{{- define "eric-lcm-package-repository-py.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-lcm-package-repository-py.mergeAnnotations" -}}
  {{- include "eric-lcm-package-repository-py.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-lcm-package-repository-py.mergeLabels" -}}
  {{- include "eric-lcm-package-repository-py.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
